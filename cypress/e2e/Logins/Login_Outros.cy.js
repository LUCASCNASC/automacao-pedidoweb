describe('Validar tela de login', () => {
    ...
    it.skip('Tentar logar no pedido web - sem usuário e senha (não deve entrar, botão Entrar desabilitado).', () => {
        ...
        /// AINDA É NECESSÁRIO VALIDAR TEXTOS DA TELA DE LOGIN ///
        ...
        cy.get('.test_btnSalvarCliente')
            .should('be.disabled') // Validando se o botão está desabilitado
            .click() //Tentando clicar no botão desabilitado (não deve permitir)
    })  
    ...
    it.skip('Tentar logar no pedido web - usuário e senha errados.', () => {
        ...
        cy.get('#txtpassword')
            .should('have.attr', 'placeholder', 'Informe sua senha') //Validando texto "Informe sua senha" dentro do campo Senha
            .type('123.senhaerrada {downArrow}') //Passando senha dentro do campo "Informe sua senha"
