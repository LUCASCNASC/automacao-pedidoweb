describe('Validar tela de login', () => {
    ...
    it.skip('Tentar logar no pedido web - passar usuario errado (não deve entrar).', () => {
        ...
        cy.get('#txtusername')
            ...
            .type('sabium.testeerrado {downArrow}') //Passando usuário dentro do campo "Informe seu usuário"
        ...
        cy.get('#txtpassword')
            ...
            .type('123.automacao {downArrow}') //Passando senha dentro do campo "Informe sua senha"
    ...
    it.skip('Tentar logar no pedido web - passar usuario errado e tentar novamente com usuário correto (deve entrar', () => {
        ...
        cy.get('#txtusername')
            .clear() //Limpando campo com usuário errado

        cy.get('.md-input-message-animation')
            .should('contain','Campo Obrigatório') //Validando mensagem de "Campo Obrigatório" quando limpo o campo de usuário

        cy.get('#txtusername')
            .type('sabium.automacao') //Preenchendo campo com usuário correto
