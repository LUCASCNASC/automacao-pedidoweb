describe('Gerar pedido com produto Kit', () => {
    ...
    it('Gerar pedido com produto Kit - caminho feliz, processo 9860, produto 1862 0 0', () => {
        ...
        cy.get('.is-expanded > v-pane-header.ng-scope > div')
            .should('contain',' Composição deste KIT ') //Validando texto "Composição deste KIT"

        cy.get('thead > tr > :nth-child(1)')
            .should('contain','Sku') //Validando nome da coluna "Sku"

        cy.get('thead > tr > :nth-child(2)')
            .should('contain','Foto') //Validando nome da coluna "Foto"

        cy.get('thead > tr > :nth-child(3)')
            .should('contain','Quantidade') //Validando nome da coluna Quantidade"

        cy.get('thead > tr > :nth-child(4)')
            .should('contain','Nome') //Validando nome da coluna "Nome"

        cy.get('thead > tr > :nth-child(5)')
            .should('contain','Saldo Local') //Validando nome da coluna "Saldo Local"

        cy.get('thead > tr > :nth-child(6)')
            .should('contain','Saldo Depósito') //Validando nome da coluna "Saldo Depósito"

        cy.get(':nth-child(1) > :nth-child(7) > .md-default')
            .should('contain','Saldo detalhado') //Validando nome do botão "Saldo detalhado"
        ...
        cy.get('[style="padding: 0px 5px;"] > .md-primary')
            ...
            .click() //clicar no botão "ADICIONAR", para adicionar produto
        ...
        cy.get('.layout-align-end-end > :nth-child(2) > .md-primary')
            ...
            .click() //Clicar no botão "FINALIZAR PEDIDO"
