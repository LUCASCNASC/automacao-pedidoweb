...
describe('Gerar pedidos com Mão de obra', () => {
    ...
    context('Sem entrega - caminho feliz', () => {
        ...
        it.skip('Gerar pedido de venda com Mão de Obra que Destaca e Não separa título, processo 9860, produto 1860 0 0', () => {
        ...
        it.skip('Gerar pedido de venda com Mão de Obra que Destaca e Não separa título, processo 9860, produto 1860 0 0; e produto 1870 0 0 sem serviço', () => {
        ...
        it.skip('Gerar pedido de venda com Mão de Obra que Não destaca e Separa título no Mesmo processo, processo 9860, produto 1860 0 0', () => {
        ...
        it.skip('Gerar pedido de venda com Mão de Obra que Não destaca e Separa título no Mesmo processo, processo 9860, produto 1860 0 0; e produto 1870 0 0 sem serviço', () => {
        ...
        it.skip('Gerar pedido de venda com Mão de Obra que Não destaca e Separa título em processo Diferente, processo 9860, produto 1860 0 0', () => {
    ...
    context('Com entrega - caminho feliz', () => {
        ...
        it.only('Gerar pedido de venda com Mão de Obra que Destaca e Não separa título, processo 9860, produto 1860 0 0; e produto 1870 0 0 sem serviço', () => {
