describe('Gerar pedido com produto solicita compra', () => {
    ...
    it('Gerar pedido de venda normal produto solicita compra, processo 9860; um produto que solicita compra, produto 1865 0 0', () => {
