...
describe('Gerar pedido de entrega futura', () => {
    ...
    context('Sem entrega', () => {
        ...
        it.skip('Gerar pedido de entrega futura, processo 9860; um produto, produto 1862 0 0 - caminho feliz', () => {
    ...
    context('Com entrega', () => {
        ...
        it.skip('Gerar pedido de entrega futura, processo 9860; um produto, produto 1862 0 0 - caminho feliz', () => {
            ...
            cy.get('#dialogContent_898 > .layout-wrap > .md-icon-float > .ng-binding')
                .click()
