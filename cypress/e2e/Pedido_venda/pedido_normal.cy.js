...
describe('Gerar pedido normal', () => {
    ...
    it.skip('Gerar pedido de venda normal, processo 9860; um produto, produto 1860 0 0 - caminho feliz', () => {
    ...
    it('Gerar pedido de venda normal, processo 9860; um produto, produto 1860 0 0 - caminho feliz', () => {
        ...
        cy.get('#searchText')
            ...
            //PROBLEMA DA ATUALIZAÇÃO DO PEDIDO WEB




        //Preenchendo campo para pesquisar segundo produto
